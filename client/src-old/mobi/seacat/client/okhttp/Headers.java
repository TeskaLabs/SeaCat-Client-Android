...
package mobi.seacat.client.okhttp;
...
public final class Headers {
  ...
  public Set<String> names() {
    TreeSet<String> result = new TreeSet<String>(FIELD_NAME_COMPARATOR);
  ...
  public List<String> values(String name) {
    ...
    for (int i = 0; i < size(); i++) {
      if ((name == null && name(i) == null) || (name != null && name.equalsIgnoreCase(name(i)))) {
